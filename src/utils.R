...
train_srr <- function(dataname, k, n_bins = 3, test_fold = 1) {
  # Create and train a Select-Regress-Round model for the given dataset with the given arguments.
  
  # Args:
  # dataname: the name of the dataset to use for training
  # k: the number of features to select
  # n_bins: number of bins to use when discretizing a numerical column
  # test_fold: defines which datapoints go to training and to test
  
  # Returns:
  # TODO
  
  # For some reason these variables need to be global
  assign("dataname", dataname, envir = .GlobalEnv)
  assign("Ms", c(1:10), envir = .GlobalEnv)
